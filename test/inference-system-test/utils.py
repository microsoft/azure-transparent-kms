...
#   --signature $signature_file \
    ...
    try:
        ...
        if kms_user_privk_path is None:
            ...
            raise ValueError("KMS_USER_PRIVK_PATH environment variable is not set")

        if kms_user_cert_path is None:
            print("Error: KMS_USER_CERT_PATH environment variable is not set")
            raise ValueError("KMS_USER_CERT_PATH environment variable is not set")
        ...
        print(
            "Cose Signed Payload: ",
            ccf.cose.create_cose_sign1(serialised_payload, key, cert, phdr),
        )
